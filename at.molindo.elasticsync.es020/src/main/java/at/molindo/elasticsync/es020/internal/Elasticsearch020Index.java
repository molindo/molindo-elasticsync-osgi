...
public class Elasticsearch020Index implements ElasticsearchIndex {
    ...
    public Elasticsearch020Index(Client client, String indexName, String query, IdAndVersionFactory idAndVersionFactory) {
        this.client = client;
	...
	public void index(final List<Document> documents, final Runnable listener) {
		...
		builder.execute(new ActionListener<BulkResponse>() {
			...
			public void onResponse(BulkResponse response) {
				...
				BulkItemResponse[] itemResponses = response.items();
